...
export default class QTParticle extends BasicParticle {
  /**
   ...
   */
  constructor({ qtIndex = 0, r = 15, ...options } = {}) {
  ...
  splitNeighbors() {
    ...
    this.neighbors.forEach((neighbor) => {
      ...
      if (angleToNeighbor > PI + this.o || angleToNeighbor < this.o)
        leftNeighbors.push(neighbor);
